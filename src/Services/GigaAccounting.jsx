        ...
        <div className={isReversedLayout(index) ? "lg:order-1" : ""}>
            <FadeUp>
                ...
                >
                    ...
                    />
                    <div
                        className={`p-5 ${card.background} border-t ${card.border}`}
                    >
...
const FeatureItem = ({ feature }) => {
    ...
    return (
        <div
            className={`flex gap-4 ${featurePadding} rounded-lg ${card.background} border ${card.border}`}
        >
...
const ModuleHeader = ({ module, index }) => {
    ...
    return (
        <div
            className={`${cardHeader} ${card.background} border-b ${card.border}`}
        >
