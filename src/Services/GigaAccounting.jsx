...
const sections = [
  {
    ...
    description:
      "Streamline your financial management with complete control over transactions, accounts, and reporting. Make informed decisions quickly and accurately.",
    image: accounting1,
    features: ["Bookkeeping Automation", "Invoice Management", "Expense Tracking"],
  },
  {
    id: 2,
    title: "Sales & Purchase Process",
    description:
      "Manage your sales and purchase operations efficiently. Automate processes, track orders, and ensure smooth workflow across all branches.",
    image: finance,
    features: ["Sales Management", "Purchase Orders", "Inventory Tracking"],
  },
  {
    id: 3,
    title: "Multi Branch & Multi Currency",
    description:
      "Handle multiple branches and currencies seamlessly. Ensure accurate financial consolidation and reporting across your organization.",
    image: tax,
    features: ["Multi Branch Support", "Multi Currency Transactions", "Tax Management"],
  },
];
