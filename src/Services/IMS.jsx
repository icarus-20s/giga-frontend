...
import ims1 from "../assets/service/ims1.jpg";
import ims2 from "../assets/service/ims2.jpg";
import ims3 from "../assets/service/ims3.jpg";
...
const sections = [
  {
    ...
    description:
      "Monitor your inventory levels in real-time, track product movements, and ensure stock availability across all locations.",
    image: ims1,
    features: ["Real-Time Tracking", "Stock Alerts", "Batch & Expiry Management"],
  },
  {
    id: 2,
    title: "Supplier & Procurement",
    description:
      "Manage suppliers, automate purchase orders, and streamline procurement processes to maintain optimal stock levels.",
    image: ims2,
    features: ["Supplier Database", "Purchase Orders", "Automated Reordering"],
  },
  {
    id: 3,
    title: "Order & Shipment Tracking",
    description:
      "Track customer orders and shipments seamlessly, ensuring timely deliveries and improved customer satisfaction.",
    image: ims3,
    features: ["Order Tracking", "Shipment Updates", "Delivery Analytics"],
  },
];
