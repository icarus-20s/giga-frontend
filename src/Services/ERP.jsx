...
const sections = [
  {
    ...
    description:
      "Manage your entire financial operations with ease. From general ledger to accounts payable and receivable, GigaERP ensures accuracy and compliance.",
    image: erp1,
    features: ["General Ledger", "Accounts Payable/Receivable", "Financial Reports"],
  },
  {
    id: 2,
    title: "Inventory & Procurement",
    description:
      "Track inventory in real-time, manage suppliers, and streamline procurement processes for optimized operations and cost savings.",
    image: erp2,
  ...
  },
  {
    ...
    title: "Sales & CRM",
    description:
      "Enhance your sales pipeline, manage customer relationships, and monitor sales performance seamlessly through integrated modules.",
    image: erp3,
    features: ["Sales Orders", "Customer Management", "Analytics & Reports"],
  },
];
