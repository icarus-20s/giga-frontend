...
import hrms1 from "../assets/service/hrms1.jpg";
import hrms2 from "../assets/service/hrms2.jpg";
import hrms3 from "../assets/service/hrms3.jpg";
...
const sections = [
  {
    ...
    description:
      "Efficiently manage employee records, attendance, leave, and performance. Keep all HR data centralized and easily accessible.",
    image: hrms1,
  ...
  },
  {
    ...
    description:
      "Automate payroll processing, salary calculations, and benefits administration, reducing errors and saving time.",
    image: hrms2,
    features: ["Automated Payroll", "Tax & Deductions", "Benefits Management"],
  },
  {
    id: 3,
    title: "Recruitment & Onboarding",
    description:
      "Streamline recruitment processes, track candidates, and ensure smooth onboarding for new employees.",
    image: hrms3,
    features: ["Applicant Tracking", "Onboarding Automation", "Interview Scheduling"],
  },
];
