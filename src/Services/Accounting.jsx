...
const sections = [
  {
    id: 1,
    title: "GigaAccounting Core",
    description:
      "Manage your finances with ease. Automate bookkeeping, track expenses, generate invoices, and get real-time financial insights with GigaAccounting.",
    image: accounting1,
    features: ["Bookkeeping Automation", "Invoice Management", "Expense Tracking"],
  },
  {
    id: 2,
    title: "Financial Reporting",
    description:
      "Generate detailed reports and analytics to make informed business decisions. Monitor cash flow, profitability, and financial health effortlessly.",
    image: finance,
    features: ["Cash Flow Reports", "Profit & Loss Statements", "Customizable Reports"],
  },
  {
    id: 3,
    title: "Tax & Compliance",
    description:
      "Stay compliant with tax regulations and automate tax calculations. Reduce errors and save time while preparing for audits and statutory filings.",
    image: tax,
    features: ["Tax Calculation", "Regulatory Compliance", "Audit Support"],
  },
];
    ...
    <section className="relative min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800">
      <div className="relative z-10 py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
        ...
        <header className="text-center mb-16 sm:mb-20 lg:mb-24">
          <h1
            className={`py-10 text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-white mb-4 sm:mb-6 transition-transform transition-opacity duration-700 ease-out transform-gpu ${
              visibleSections["header"] ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
            }`}
            ref={(el) => (sectionRefs.current[0] = el)}
            data-id="header"
          >
            GigaAccounting Overview
          </h1>
        </header>
