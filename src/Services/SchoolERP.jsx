...
const MobileFeatureCard = ({ feature }) => {
    ...
    return (
        <div
            className={`p-6 rounded-xl ${card.background} border ${card.border} text-center`}
        >
            <div
                className={`w-16 h-16 mx-auto mb-4 rounded-xl ${accent.primary} flex items-center justify-center`}
            >
                <MobileIcon />
            </div>
