          ...
          <div className="grid gap-10 lg:grid-cols-4 lg:gap-12">
            ...
            <div className="lg:col-span-1">
              <div className="mb-8 flex items-center gap-4">
                <div className="h-12 w-12 overflow-hidden rounded-xl shadow-lg">
                  <img src={logo} alt="Giga Infosoft Logo" className="h-full w-full object-cover" />
                </div>
                <div>
                  <h2 className="text-2xl font-bold">Giga Infosoft</h2>
                  <p className="text-sm text-blue-400">Technology Solutions</p>
                </div>
              </div>
              ...
              <div className="mb-8 space-y-4 py-5">
                ...
                <div className="flex items-center gap-3 text-slate-300">
                  ...
                  <span className="text-sm">+977 9840073584</span>
                </div>
                <div className="flex items-center gap-3 text-slate-300">
                  <Mail size={18} className="text-purple-400" />
                  <span className="text-sm">info@gigainfosoft.com.np</span>
                </div>
              </div>
            ...
            <div>
              ...
              <p className="mb-5 text-sm text-slate-400">
                Subscribe to get updates on the latest tech trends and offers.
              </p>
              ...
              <form onSubmit={handleSubscribe} className="flex flex-col gap-3">
                ...
                {loading && <Loader />}
                {subscribeStatus && (
                  <p className={`text-xs ${subscribeStatus.includes("Thank") || subscribeStatus.includes("already") ? "text-green-400" : "text-red-400"}`}>
                    {subscribeStatus}
                  </p>
                )}
              </form>
        ...
        <div className="border-t border-slate-700/50">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex flex-col items-center justify-between gap-4 text-center text-sm text-slate-400 sm:flex-row">
              <p>© 2025 Giga Infosoft Pvt. Ltd. All rights reserved.</p>
              <p className="text-xs">Crafted with passion in Nepal</p>
            </div>
          </div>
        </div>
      </div>
