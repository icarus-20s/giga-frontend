...
/>
                ...
                <div>
                  <h2 className="text-2xl font-bold text-white">Giga Infosoft</h2>
                  <p className="text-blue-300 text-sm">Technology Solutions</p>
                </div>
              </div>
            ...
            <div>
              ...
              <div>
                ...
                <div className="flex">
                  ...
                  />
                  <button className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-r-lg transition-colors text-xs font-medium">
                    Join
                  </button>
                </div>
              </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
              <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-4 text-center sm:text-left">
                ...
                <p className="text-slate-500 text-xs">
                  Crafted with ❤️ by <span className="text-slate-300 font-medium">Ayush</span>
                </p>
              </div>
              ...
              <div className="flex flex-wrap gap-4 text-xs">
                ...
                <a href="#cookies" className="text-slate-400 hover:text-white transition-colors">Cookies</a>
              </div>
            </div>
          </div>
        </div>
